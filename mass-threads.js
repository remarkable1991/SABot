  ...
  async execute(interaction, { discordClient }) {
    ...
    try {
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        // Handle optional time slots if present (columns 2, 3, 4)
        ...
        rulesEmbed.addFields(
          ...
          { name: '💤 Player Non-Responsiveness', value: 'Tag your opponents if they do not respond. If a player fails to respond or make a move for **over 24 hours**, tag our tournament support team listed in the pin above.', inline: false },
